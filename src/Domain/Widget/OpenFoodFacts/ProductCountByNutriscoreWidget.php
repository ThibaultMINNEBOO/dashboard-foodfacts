...
class ProductCountByNutriscoreWidget implements WidgetDataProviderInterface
{
    ...
    {
        return $type === WidgetType::PRODUCT_COUNT_BY_NUTRISCORE;
    }
    ...
    public function getData(array $configuration): WidgetResponseInterface
    {
        try {
            $products = $this->apiClient->searchProducts([
                'nutrition_grades_tags' => $configuration['nutriscore'],
            ]);
